...
HD_PWD='E:/Final_Project/led_blinker_files/simple_led_bilnker/simple_led_bilnker.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Inst_top_down_cntr.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Inst_top_down_cntr.tcl
